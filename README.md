# PalmerRV
The Greek base text by Edwin Palmer, 1882, which lies behind the Revised Version New Testament of 1881, with notes showing deviations from Westcott-Hort.

The Greek text is from _Η ΚΑΙΝΗ ΔΙΑΘΗΚΗ: The Greek New Testament with the Readings Adopted by the Revisers of the Authorised Version and with References in the Margin to Parallel Passages of the Old and the New Testament_, Oxford at the Clarendon Press, 1882.

## Main text features

* Accepts, breathing marks, and puncutation throughout, following Palmer's conventions.
* Attempted to follow Palmer's verse divisions, although this is not always clear in his printed edition, so this represents a best effort.

## Note features

* Notes show differences between the Palmer Greek base text and the Westcott-Hort _The New Testament in the Original Greek_ of 1881.
* Notes appear inside curly braces, intermixed with the Greek base text.
* Verse division differences from Westcott-Hort are not noted.
* For the sake of brevity, differences due to movable Nu, terminal Sigma, and minor orthographic variations are not shown.
* Words that are spelled differently, but have the same meaning (such as variation in the spelling of names) _are_ noted.
...
05:31 ἐρρέθη δὲ {οτι ¦ WH om.} ὅτι Ὃς ἂν ἀπολύσῃ τὴν γυναῖκα αὐτοῦ, δότω αὐτῇ ἀποστάσιον·

In this case, the "om." notation indicates that Westcott-Hort _omits_ the given stretch of Palmer base text.
